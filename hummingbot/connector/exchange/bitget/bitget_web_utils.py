...
def rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    :param domain: the Bitget domain to connect to ("mainnet" or "testnet"). The default value is "mainnet"
...
def get_rest_url_for_endpoint(endpoint: str, domain: str = None):
...
async def get_current_server_time(
    ...
    url = public_rest_url(path_url=CONSTANTS.QUERY_SERVER_TIME_ENDPOINT)
    response = await rest_assistant.execute_request(
        url=url,
        throttler_limit_id=CONSTANTS.QUERY_SERVER_TIME_ENDPOINT,
