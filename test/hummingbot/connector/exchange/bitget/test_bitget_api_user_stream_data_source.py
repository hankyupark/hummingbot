...
class BitgetUserStreamDataSourceTests(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.ex_trading_pair = cls.base_asset + cls.quote_asset + "_SPBL"
        cls.domain = None
    ...
    def _subscription_response(self, subscribed: bool, subscription: str) -> str:
        message = {
            "event": "subscribe",
            "arg": [{"instType": CONSTANTS.INSTRUMENT_TYPE_SPOT_PRIVATE_CHANNEL, "channel": subscription, "instId": "BTCUSDT"}]
        }
